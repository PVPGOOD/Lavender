...
public final class FontDrawer {
    ...
    private static final int SHADOW_COLOR = ColorUtility.getRGB(0,0,0,180);
    ...
    public void drawStringWithShadowDirectly(String s, double x, double y, int color) {
        final int alpha = ColorUtility.getAlpha(color);

        drawStringDirectly(s, x + 0.5, y + 0.5, alpha < 200 ? ColorUtility.reAlpha(SHADOW_COLOR, alpha) : SHADOW_COLOR);
    ...
    public void drawStringWithShadow(String s, double x, double y, int color) {
        ...
        drawString(s, x + 0.5, y + 0.5, alpha < 200 ? ColorUtility.reAlpha(SHADOW_COLOR, alpha) : SHADOW_COLOR, true);
                    ...
                    switch (colorIndex) {
                        ...
                        default:
                            if (!shadow) {
                                ...
                                OGLUtility.color(ColorUtility.getRed(finalColor), ColorUtility.getGreen(finalColor), ColorUtility.getBlue(finalColor), ColorUtility.getAlpha(color));
                            }
    ...
    public void drawCharWithShadow(char c, double x, double y, int color) {
        ...
        drawChar(c, x + 0.5, y + 0.5, alpha < 200 ? ColorUtility.reAlpha(SHADOW_COLOR, alpha) : SHADOW_COLOR);
