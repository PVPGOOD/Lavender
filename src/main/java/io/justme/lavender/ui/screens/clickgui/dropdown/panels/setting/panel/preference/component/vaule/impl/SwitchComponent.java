...
@Getter
@Setter
public class SwitchComponent extends AbstractSettingComponent {
    ...
    public SwitchComponent() {
        this.moduleComponentType = SettingComponentType.SWITCH;
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        font.drawString(getOption().getName(),getDescriptionX(),getDescriptionY(),new Color(0,0,0,155).getRGB());
