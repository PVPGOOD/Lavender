...
public class CheckboxComponent extends AbstractSettingComponent {
    ...
    public CheckboxComponent() {
        this.moduleComponentType = SettingComponentType.CHECKBOX;
        setWidth(10);
        setHeight(10);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        font.drawString(
                getOption().getName(),
                getDescriptionX() + 2,getDescriptionY() + getHeight() /2f - getFontDrawer().getHeight() /2f,new Color(0,0,0,155).getRGB());
