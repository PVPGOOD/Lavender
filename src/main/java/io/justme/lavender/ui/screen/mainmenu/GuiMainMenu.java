...
public class GuiMainMenu extends GuiScreen {
    ...
    public void initGui()
    {
        ...
        buttonList.add(new GuiButton(2, 20,  80,80,20, "Language"));
        buttonList.add(new GuiButton(3, 20,  100,80,20, "Options"));
        buttonList.add(new GuiButton(4, 20,  120,80,20, "ShutDown"));
    }
