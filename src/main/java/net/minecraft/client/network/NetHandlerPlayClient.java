...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn)
    {
        ...
        if (La.getINSTANCE().getSettingManager().getPushNotificationOnFirstJoinServer().getValue()) {
            La.getINSTANCE().getNotificationsManager().push("AltManager",
                    "你当前正在使用 " + getGameProfile().getName() + " 账号 进行游玩", NotificationsEnum.INFO, 3000);
        }
    }
