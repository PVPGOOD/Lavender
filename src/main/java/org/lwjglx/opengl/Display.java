...
import org.lwjglx.LWJGLXConfig;
import org.lwjglx.LWJGLX;
...
public class Display {
    ...
    public static void create() {
        ...
        glfwWindowHint(GLFW_MAXIMIZED, LWJGLXConfig.WINDOW_START_MAXIMIZED ? GLFW_TRUE : GLFW_FALSE);
        glfwWindowHint(GLFW_FOCUSED, LWJGLXConfig.WINDOW_START_FOCUSED ? GLFW_TRUE : GLFW_FALSE);
        displayFocused = LWJGLXConfig.WINDOW_START_FOCUSED;
        glfwWindowHint(GLFW_ICONIFIED, LWJGLXConfig.WINDOW_START_ICONIFIED ? GLFW_TRUE : GLFW_FALSE);
        displayVisible = !LWJGLXConfig.WINDOW_START_ICONIFIED;
        glfwWindowHint(GLFW_DECORATED, LWJGLXConfig.WINDOW_DECORATED ? GLFW_TRUE : GLFW_FALSE);

        glfwWindowHint(GLFW_SRGB_CAPABLE, LWJGLXConfig.OPENGL_SRGB_CONTEXT ? GLFW_TRUE : GLFW_FALSE);
        glfwWindowHint(GLFW_DOUBLEBUFFER, LWJGLXConfig.OPENGL_DOUBLEBUFFER ? GLFW_TRUE : GLFW_FALSE);
        glfwWindowHint(GLFW_CONTEXT_NO_ERROR, LWJGLXConfig.OPENGL_CONTEXT_NO_ERROR ? GLFW_TRUE : GLFW_FALSE);
        glfwWindowHint(GLFW_OPENGL_DEBUG_CONTEXT, LWJGLXConfig.OPENGL_DEBUG_CONTEXT ? GLFW_TRUE : GLFW_FALSE);
        glfwWindowHint(GLFW_OPENGL_DEBUG_CONTEXT, LWJGLXConfig.OPENGL_DEBUG_CONTEXT ? GLFW_TRUE : GLFW_FALSE);

        glfwWindowHintString(GLFW_X11_CLASS_NAME, LWJGLXConfig.X11_CLASS_NAME);
        glfwWindowHintString(GLFW_COCOA_FRAME_NAME, LWJGLXConfig.COCOA_FRAME_NAME);
        ...
        Window.keyCallback = new GLFWKeyCallback() {
            ...
            public void invoke(long window, int key, int scancode, int action, int mods) {
                if (LWJGLXConfig.DEBUG_PRINT_KEY_EVENTS) {
                    LWJGLX.LOG.info(
        ...
        Window.cursorPosCallback = new GLFWCursorPosCallback() {
            ...
            public void invoke(long window, double xpos, double ypos) {
                if (LWJGLXConfig.DEBUG_PRINT_MOUSE_EVENTS) {
                    LWJGLX.LOG.info("[DEBUG-MOUSE] cursorPos window:{} xpos:{} ypos:{}", window, xpos, ypos);
                }
        ...
        Window.scrollCallback = new GLFWScrollCallback() {
            ...
            public void invoke(long window, double xoffset, double yoffset) {
                if (LWJGLXConfig.DEBUG_PRINT_MOUSE_EVENTS) {
                    LWJGLX.LOG.info("[DEBUG-MOUSE] wheel window:{} xoffset:{} yoffset:{}", window, xoffset, yoffset);
                }
        ...
        Window.windowFocusCallback = new GLFWWindowFocusCallback() {
            ...
            public void invoke(long window, boolean focused) {
                if (LWJGLXConfig.DEBUG_PRINT_MOUSE_EVENTS) {
                    LWJGLX.LOG.info("[DEBUG-MOUSE] focus window:{} focus:{}", window, focused);
                }
        ...
        Window.windowIconifyCallback = new GLFWWindowIconifyCallback() {
            ...
            public void invoke(long window, boolean iconified) {
                if (LWJGLXConfig.DEBUG_PRINT_MOUSE_EVENTS) {
                    LWJGLX.LOG.info("[DEBUG-MOUSE] focus window:{} iconified:{}", window, iconified);
                }
        ...
        Window.windowSizeCallback = new GLFWWindowSizeCallback() {
            ...
            public void invoke(long window, int width, int height) {
                if (LWJGLXConfig.DEBUG_PRINT_MOUSE_EVENTS) {
                    LWJGLX.LOG.info("[DEBUG-MOUSE] window-resize window:{} w:{} h:{}", window, width, height);
                }
                latestResized = true;
                latestWidth = width;
                latestHeight = height;
        ...
        Window.framebufferSizeCallback = new GLFWFramebufferSizeCallback() {
            ...
            public void invoke(long window, int width, int height) {
                if (LWJGLXConfig.DEBUG_PRINT_MOUSE_EVENTS) {
                    LWJGLX.LOG.info("[DEBUG-MOUSE] framebuffer-resize window:{} w:{} h:{}", window, width, height);
                }
